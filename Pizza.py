...
#--  page 1------
    def main(sf):
        ...
        sf.mainf1=Frame(sf.scr,height=150,width=1400)
        sf.logo=PhotoImage(file="newlabel.png")
        ...
        sf.lab=Button(sf.mainf2,text= "Click Here to enter the World of Pizzas",command=lambda:sf.Login(),cursor="hand2", bd=10 ,font=("Arial Black",30, 'bold'),fg="#F61B46",bg="#0b1335")
...
#------ page 2------
    def Login(sf):
        ...
        sf.c.create_image(683,284,image=sf.logo1)
        sf.c.create_rectangle(50,100,700,450,fill="#D2CC27",outline="white",width=6)
        ...
        sf.pasd=Entry(sf.loginf2,bg="white",font=("cooper black",22),bd=6 ,show="*",justify='left')
        ...
        sf.rg=Button(sf.loginf2,text="New to Bhagyashri Pizza",command=lambda:sf.Register(),fg="#400216",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
    ...
    def about(sf):
        sf.scr1=Tk()
        sf.L=Label(sf.scr1,font=('Courier',-30,'bold underline'),text="NEW PIZZA SHOP *Bhagyashri Patil.(8987654567)",width=50,height=2,fg='goldenrod4',bg='yellow')
        sf.L.pack()
        sf.scr1.mainloop()
#--  page 3------
    def Adminlogin(sf):
...
#--  page 5------
    def adminmain(sf):
        ...
        def Ref(sf):
            ...
            sf.costofmeal = "Rs.",str('%.2f'% (sf.p1+sf.p2+sf.p3+sf.p4+sf.p5+sf.p6+sf.p7+sf.p8))
            sf.PayTax=((sf.p1+sf.p2+sf.p3+sf.p4+sf.p5+sf.p6+sf.p7+sf.p8)*.05)
            sf.Totalcost=(sf.p1+sf.p2+sf.p3+sf.p4+sf.p5+sf.p6+sf.p7+sf.p8)
            sf.Ser_Charge=((sf.p1+sf.p2+sf.p3+sf.p4+sf.p5+sf.p6+sf.p7+sf.p8)/99)
...
#--  page 6------        
    def menulist(sf,x):
        ...
        sf.menuf2=Frame(sf.scr,height=618,width=1368)
        sf.c=Canvas(sf.menuf2,height=618,width=1368)
        sf.c.pack()
        sf.logo1=PhotoImage(file="pizzamain.png")
        sf.c.create_image(683,309,image=sf.logo1)
        sf.c.create_rectangle(400,120,966,470,fill="#d3ede6",outline="white",width=6)
        sf.veg=PhotoImage(file="veg.png")
        sf.c.create_image(540,260,image=sf.veg)
        ...
        sf.vegbut.place(x=480,y=400)
        sf.nonveg=PhotoImage(file="Non.png")
        sf.c.create_image(835,260,image=sf.nonveg)
        ...
        sf.nonvegbut.place(x=720,y=400)
...
#--  page 12------
 ...
 #-----  database-------               
    ...
    def orderpay(sf,x):
        ...
        messagebox.showinfo("Pay","Order done..!!!")
